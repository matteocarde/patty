...
class TestLinearFarmland(TestCase):

    def setUp(self) -> None:
        self.folder = "../../files/ipc-2023/fo-farmland"
        self.domain: Domain = Domain.fromFile(f"{self.folder}/domain.pddl")
        self.problem: Problem = Problem.fromFile(f"{self.folder}/instances/instance_4_800_1229.pddl")
