...
class TestTranslatePathwaysmetric(TestCase):

    def setUp(self) -> None:
        self.folder = "../../files/ipc-2023/pathwaysmetric"
        self.domain: Domain = Domain.fromFile(f"{self.folder}/domain.pddl")
        self.problem: Problem = Problem.fromFile(f"{self.folder}/instances/pfile21.pddl")
