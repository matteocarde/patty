...
class TestAStarSettlers(TestCase):

    def setUp(self) -> None:
        domainFile = "../../files/numeric/ipc-2023/settlers/domain.pddl"
        problemFile = "../../files/numeric/ipc-2023/settlers/instances/pfile02.pddl"
