...
class TestStepSearchMPrime(TestCase):

    def setUp(self) -> None:
        domainFile = "../../files/numeric/ipc-2023/mprime/domain.pddl"
        problemFile = "../../files/numeric/ipc-2023/mprime/instances/pfile02.pddl"
