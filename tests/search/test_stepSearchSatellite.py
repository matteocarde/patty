...
class TestStepSearchSatellite(TestCase):

    def setUp(self) -> None:
        domainFile = "../../files/numeric/ipc-2023/satellite/domain.pddl"
        problemFile = "../../files/numeric/ipc-2023/satellite/instances/pfile2.pddl"
