...
class TestPlantWatering(TestCase):
    ...
    def setUp(self) -> None:
        self.domain: Domain = Domain.fromFile("../../files/numeric/ipc-2023/ext-plant-watering/domain.pddl")
        self.problem: Problem = Problem.fromFile(
            "../../files/numeric/ipc-2023/ext-plant-watering/instances/instance_10_5_2_1.pddl")
