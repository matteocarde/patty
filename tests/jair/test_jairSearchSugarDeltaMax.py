...
class TestJairCounterDeltaMax(TestCase):

    def setUp(self) -> None:
        domainFile = "../../files/numeric/ipc-2023/sugar/domain.pddl"
        problemFile = "../../files/numeric/ipc-2023/sugar/instances/pfile04.pddl"

        self.domain: Domain = Domain.fromFile(domainFile)
        self.problem: Problem = Problem.fromFile(problemFile)
        self.gDomain: GroundedDomain = self.domain.ground(self.problem)
        self.args = Arguments(keepRequired=False)
        self.args.goalFunction = "DELTA-MAX"
        pass
