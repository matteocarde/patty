...
class TestBDCFarmland(TestCase):

    def setUp(self) -> None:
        domainFile = "../../files/numeric/ipc-2023/farmland/domain.pddl"
        problemFile = "../../files/numeric/ipc-2023/farmland/instances/instance_8_700_1229.pddl"
