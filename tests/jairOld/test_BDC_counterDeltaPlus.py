...
class TestBDCCounterDeltaPlus(TestCase):

    def setUp(self) -> None:
        domainFile = "../../files/numeric/ipc-2023/counters/domain.pddl"
        problemFile = "../../files/numeric/ipc-2023/counters/instances/fz_instance_12.pddl"
