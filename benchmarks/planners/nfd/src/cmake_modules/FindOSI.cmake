# - Find the Open Search Interface by COIN/OR.
...
if(OSI_Cpx_LIBRARIES)
    ...
    if (CPLEX_FOUND AND CONCERT_FOUND)
        list(APPEND OSI_IPCpx_LIBRARIES ${CPLEX_LIBRARIES})
        list(APPEND OSI_IPCpx_LIBRARIES ${CONCERT_LIBRARIES})
        list(APPEND OSI_IPCpx_INCLUDE_DIRS ${CPLEX_INCLUDE_DIRS})
        list(APPEND OSI_IPCpx_INCLUDE_DIRS ${CONCERT_INCLUDE_DIRS})
	mark_as_advanced(OSI_IPCpx_LIBRARY_RELEASE OSI_IPCpx_LIBRARY_DEBUG
                     OSI_IPCpx_LIBRARIES OSI_IPCpx_INCLUDE_DIRS)
      set(OSI_IPCpx_FOUND TRUE)
    endif()
endif()
