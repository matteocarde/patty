...
DOMAINS = {
    "counters": ("numeric/ipc-2023/counters", "ENHSP-OPT-HMRPHJ"),
    ...
    "plant-watering": ("numeric/ipc-2023/ext-plant-watering", "ENHSP-OPT-HMRPHJ"),
    "farmland": ("numeric/ipc-2023/farmland", "ENHSP-OPT-HMRPHJ"),
    ...
    "sailing": ("numeric/ipc-2023/sailing", "ENHSP-OPT-HMRPHJ"),
