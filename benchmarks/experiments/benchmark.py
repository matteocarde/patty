...
PLANNERS: Dict[str, Planner] = {
    ...
    "PATTY-H-GAMMA-MAX": Patty("PATTY-H-GAMMA-MAX", search="jair", pattern="enhanced", goalFunction="GAMMA-MAX"),
    "PATTY-H-GAMMA-GC": Patty("PATTY-H-GAMMA-GC", search="jair", pattern="enhanced", goalFunction="GAMMA-GC"),
    "PATTY-H-GAMMA-PLUS": Patty("PATTY-H-GAMMA-PLUS", search="jair", pattern="enhanced", goalFunction="GAMMA-PLUS"),
    "PATTY-H-GAMMA-XOR": Patty("PATTY-H-GAMMA-XOR", search="jair", pattern="enhanced", goalFunction="GAMMA-XOR"),
    "PATTY-H-DELTA-MAX": Patty("PATTY-H-DELTA-MAX", search="jair", pattern="enhanced", goalFunction="DELTA-MAX"),
    "PATTY-H-DELTA-PLUS": Patty("PATTY-H-DELTA-PLUS", search="jair", pattern="enhanced", goalFunction="DELTA-PLUS"),
    "PATTY-H-DELTA-XOR": Patty("PATTY-H-DELTA-XOR", search="jair", pattern="enhanced", goalFunction="DELTA-XOR"),
