...
PLANNERS: Dict[str, Planner] = {
    ...
    "PATTY-H-GAMMA-MAX": Patty("PATTY-H-GAMMA-MAX", search="jair", goalFunction="GAMMA-MAX"),
    "PATTY-H-GAMMA-GC": Patty("PATTY-H-GAMMA-GC", search="jair", goalFunction="GAMMA-GC"),
    "PATTY-H-GAMMA-PLUS": Patty("PATTY-H-GAMMA-PLUS", search="jair", goalFunction="GAMMA-PLUS"),
    "PATTY-H-GAMMA-XOR": Patty("PATTY-H-GAMMA-XOR", search="jair", goalFunction="GAMMA-XOR"),
    "PATTY-H-DELTA-MAX": Patty("PATTY-H-DELTA-MAX", search="jair", goalFunction="DELTA-MAX"),
    "PATTY-H-DELTA-PLUS": Patty("PATTY-H-DELTA-PLUS", search="jair", goalFunction="DELTA-PLUS"),
    "PATTY-H-DELTA-XOR": Patty("PATTY-H-DELTA-XOR", search="jair", goalFunction="DELTA-XOR"),

    "PATTY-H-OPT-GAMMA-MAX": Patty("PATTY-H-OPT-GAMMA-MAX", search="jair", goalFunction="GAMMA-MAX",
                                   minimizeGoalFunction=True, noCompression=True),
    "PATTY-H-OPT-GAMMA-GC": Patty("PATTY-H-OPT-GAMMA-GC", search="jair", goalFunction="GAMMA-GC",
                                  minimizeGoalFunction=True, noCompression=True),
    "PATTY-H-OPT-GAMMA-PLUS": Patty("PATTY-H-OPT-GAMMA-PLUS", search="jair", goalFunction="GAMMA-PLUS",
                                    minimizeGoalFunction=True, noCompression=True),
    "PATTY-H-OPT-GAMMA-XOR": Patty("PATTY-H-OPT-GAMMA-XOR", search="jair", goalFunction="GAMMA-XOR",
                                   minimizeGoalFunction=True, noCompression=True),
    "PATTY-H-OPT-DELTA-MAX": Patty("PATTY-H-OPT-DELTA-MAX", search="jair", goalFunction="DELTA-MAX",
                                   minimizeGoalFunction=True, noCompression=True),
    "PATTY-H-OPT-DELTA-PLUS": Patty("PATTY-H-OPT-DELTA-PLUS", search="jair", goalFunction="DELTA-PLUS",
                                    minimizeGoalFunction=True, noCompression=True),
    "PATTY-H-OPT-DELTA-XOR": Patty("PATTY-H-OPT-DELTA-XOR", search="jair", goalFunction="DELTA-XOR",
                                   minimizeGoalFunction=True, noCompression=True),

    "PATTY-F-OPT-GAMMA-MAX": Patty("PATTY-F-OPT-GAMMA-MAX", search="jair", goalFunction="GAMMA-MAX",
                                   minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-GAMMA-GC": Patty("PATTY-F-OPT-GAMMA-GC", search="jair", goalFunction="GAMMA-GC",
                                  minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-GAMMA-PLUS": Patty("PATTY-F-OPT-GAMMA-PLUS", search="jair", goalFunction="GAMMA-PLUS",
                                    minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-GAMMA-XOR": Patty("PATTY-F-OPT-GAMMA-XOR", search="jair", goalFunction="GAMMA-XOR",
                                   minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-DELTA-MAX": Patty("PATTY-F-OPT-DELTA-MAX", search="jair", goalFunction="DELTA-MAX",
                                   minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-DELTA-PLUS": Patty("PATTY-F-OPT-DELTA-PLUS", search="jair", goalFunction="DELTA-PLUS",
                                    minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-DELTA-XOR": Patty("PATTY-F-OPT-DELTA-XOR", search="jair", goalFunction="DELTA-XOR",
                                   minimizeGoalFunction=True, noCompression=False),

    "PATTY-F-OPT-GAMMA-MAX-CLAUSES": Patty("PATTY-F-OPT-GAMMA-MAX-CLAUSES", search="jair",
                                           goalFunction="GAMMA-MAX-CLAUSES",
                                           minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-GAMMA-GC-CLAUSES": Patty("PATTY-F-OPT-GAMMA-GC-CLAUSES", search="jair",
                                          goalFunction="GAMMA-GC-CLAUSES",
                                          minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-GAMMA-PLUS-CLAUSES": Patty("PATTY-F-OPT-GAMMA-PLUS-CLAUSES", search="jair",
                                            goalFunction="GAMMA-PLUS-CLAUSES",
                                            minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-DELTA-MAX-CLAUSES": Patty("PATTY-F-OPT-DELTA-MAX-CLAUSES", search="jair",
                                           goalFunction="DELTA-MAX-CLAUSES",
                                           minimizeGoalFunction=True, noCompression=False),
    "PATTY-F-OPT-DELTA-PLUS-CLAUSES": Patty("PATTY-F-OPT-DELTA-PLUS-CLAUSES", search="jair",
    ...
    "PATTY-F-OPT-DELTA-XOR-CLAUSES": Patty("PATTY-F-OPT-DELTA-XOR-CLAUSES", search="jair",
                                           ...
                                           minimizeGoalFunction=True, noCompression=False),
    "PATTY-GD-DELTA-MAX-CLAUSES": Patty("PATTY-GD-DELTA-MAX-CLAUSES", search="gd", goalFunction="DELTA-MAX-CLAUSES"),
    "PATTY-GD-DELTA-PLUS-CLAUSES": Patty("PATTY-GD-DELTA-PLUS-CLAUSES", search="gd", goalFunction="DELTA-PLUS-CLAUSES"),
    "PATTY-GD-DELTA-XOR-CLAUSES": Patty("PATTY-GD-DELTA-XOR-CLAUSES", search="gd", goalFunction="DELTA-XOR-CLAUSES"),
    "PATTY-BDC-DELTA-MAX-CLAUSES": Patty("PATTY-BDC-DELTA-MAX-CLAUSES", search="bdc", goalFunction="DELTA-MAX-CLAUSES"),
    "PATTY-BDC-DELTA-PLUS-CLAUSES": Patty("PATTY-BDC-DELTA-PLUS-CLAUSES", search="bdc",
                                          goalFunction="DELTA-PLUS-CLAUSES"),
    "PATTY-BDC-DELTA-XOR-CLAUSES": Patty("PATTY-BDC-DELTA-XOR-CLAUSES", search="bdc", goalFunction="DELTA-XOR-CLAUSES"),
