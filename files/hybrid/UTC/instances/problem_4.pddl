...
(:domain urbantraffic)
(:objects ter1 ter2 ter3 - intersection r1 r2 r3 r4 r5 r6 r7n r7s r8 r9 r10 - road buf0 - buffer)
(:init
...
(= (saturated_queue r1) 20)
(= (saturated_queue r2) 20)
(= (saturated_queue r3) 20)
(= (saturated_queue r5) 20)
(= (saturated_queue r7s) 20)
...
(and
 ...
 (< (queue r5) (saturated_queue r5))
 (< (queue r7s) (saturated_queue r7s))
