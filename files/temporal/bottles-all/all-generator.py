...
def main():
    ...
    for bottles in range(minBottles, maxBottles + 1, 2):
        ...
        pddl.append("(:domain bottles-all)")
        pddl.append("\t(:objects")
        ...
        for i in range(0, left):
            pddl.append(f"\t\t\t(packed l{i + 1})")
        for i in range(0, right):
            pddl.append(f"\t\t\t(packed r{i + 1})")
        pddl.append("\t\t)")
        pddl.append("\t)")
        pddl.append(")")
        ...
        for i in range(0, left):
            anml.append(f"[end] packed(l{i + 1}) == true;")
        for i in range(0, right):
            anml.append(f"[end] packed(r{i + 1}) == true;")
