...
(define (domain Pathways-Metric)
	...
	(:action associate
		...
		:effect (and (decrease
				(available ?x1)
				(need-for-association ?x1 ?x2 ?x3))
			(decrease
				(available ?x2)
				(need-for-association ?x2 ?x1 ?x3))
			(increase
				(available ?x3)
				(prod-by-association ?x1 ?x2 ?x3)))
	)
	...
	(:action associate-with-catalyze
		...
		:effect (and (decrease
				(available ?x1)
				(need-for-catalyzed-association ?x1 ?x2 ?x3))
			...
			(increase
				(available ?x3)
				(prod-by-catalyzed-association ?x1 ?x2 ?x3)))
	)
	...
	(:action self-associate-with-catalyze
		...
		:effect (and (decrease
				(available ?x1)
				(need-for-catalyzed-self-association ?x1 ?x3))
			(increase
				(available ?x3)
				(prod-by-catalyzed-self-association ?x1 ?x3)))
	)
