(define (problem prob1)
	...
	(:init
		(= (unharvest-field) 14.0)
		(= (mill-cost) 4.0)
		(= (inventory-cost) 0.0)
		(= (handling-cost) -22.0)
		(= (cost-process mill1) 14.0)
		(= (cost-process mill2) -12.0)
		(= (has-resource sugar-cane mill1) -31.0)
		(= (has-resource sugar-cane mill2) -23.0)
		(= (max-changing mill1) 38.0)
		(= (max-changing mill2) 1.0)
		(= (max-produce mill1) 15.0)
		(= (max-produce mill2) 19.0)
		(available mill1)
		(available mill2)
		...
		(= (in-storage mill1 brand1) 19.0)
		(= (in-storage mill1 brand3) -13.0)
		(= (in-storage mill1 brand4) -16.0)
		(= (in-storage mill2 brand1) 29.0)
		(= (in-storage mill2 brand2) -4.0)
		...
		(ready-crane crane2)
		(= (capacity crane1) 8.0)
		(= (capacity crane2) 27.0)
		(= (service-time crane1) -18.0)
		(= (service-time crane2) -13.0)
		(= (service-time crane3) 12.0)
		(= (max-service-time crane1) 0.0)
		(= (max-service-time crane2) 29.0)
		(= (max-service-time crane3) 22.0)
		(= (in-truck-sugar brand1 truck1) 9.0)
		(= (in-truck-sugar brand2 truck1) 24.0)
		(= (in-truck-sugar brand3 truck1) -2.0)
		(= (in-truck-sugar brand4 truck1) -31.0)
		(= (in-truck-sugar brand1 truck2) 34.0)
		(= (in-truck-sugar brand2 truck2) -24.0)
		(= (in-truck-sugar brand3 truck2) -40.0)
		(= (in-truck-sugar brand4 truck2) 32.0)
		(= (in-storage depot1 brand1) -19.0)
		(= (in-storage depot1 brand2) -37.0)
		(= (in-storage depot1 brand3) 38.0)
		(= (in-storage depot1 brand4) 12.0)
		(= (in-storage depot2 brand1) -27.0)
		(= (in-storage depot2 brand2) -32.0)
		(= (in-storage depot2 brand3) -31.0)
		(= (in-storage depot2 brand4) 39.0)
		(= (in-storage depot3 brand1) 5.0)
		(= (in-storage depot3 brand2) 10.0)
		(= (in-storage depot3 brand3) -25.0)
