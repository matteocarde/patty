(define (problem prob1)
	...
	(:init
		...
		(= (inventory-cost) -5.0)
		(= (handling-cost) -1.0)
		(= (cost-process mill1) 4.0)
		(= (cost-process mill2) 3.0)
		(= (has-resource sugar-cane mill1) -2.0)
		(= (has-resource sugar-cane mill2) 4.0)
		(= (max-changing mill1) -2.0)
		(= (max-changing mill2) 4.0)
		(= (max-produce mill1) 7.0)
		(= (max-produce mill2) 6.0)
		(available mill1)
		(available mill2)
		...
		(= (in-storage mill1 brand1) -3.0)
		(= (in-storage mill1 brand3) -2.0)
		(= (in-storage mill1 brand4) -2.0)
		...
		(= (capacity crane1) 1.0)
		(= (capacity crane2) 6.0)
		(= (service-time crane1) 13.0)
		(= (service-time crane2) 18.0)
		(= (service-time crane3) 9.0)
		(= (max-service-time crane1) 13.0)
		(= (max-service-time crane2) 19.0)
		(= (max-service-time crane3) 5.0)
		(= (in-truck-sugar brand1 truck1) 0.0)
		(= (in-truck-sugar brand2 truck1) 1.0)
		(= (in-truck-sugar brand3 truck1) 2.0)
		(= (in-truck-sugar brand4 truck1) -4.0)
		(= (in-truck-sugar brand1 truck2) 1.0)
		(= (in-truck-sugar brand2 truck2) -1.0)
		(= (in-truck-sugar brand3 truck2) 4.0)
		(= (in-truck-sugar brand4 truck2) 3.0)
		(= (in-storage depot1 brand1) 1.0)
		(= (in-storage depot1 brand2) -3.0)
		(= (in-storage depot1 brand3) -3.0)
		(= (in-storage depot1 brand4) 4.0)
		(= (in-storage depot2 brand1) -1.0)
		(= (in-storage depot2 brand2) -3.0)
		(= (in-storage depot2 brand3) 4.0)
		(= (in-storage depot2 brand4) -2.0)
		(= (in-storage depot3 brand1) 1.0)
		(= (in-storage depot3 brand2) 1.0)
		(= (in-storage depot3 brand3) 3.0)
		(= (in-storage depot3 brand4) 1.0)
