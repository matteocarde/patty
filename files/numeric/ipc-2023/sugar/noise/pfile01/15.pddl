(define (problem prob1)
	...
	(:init
		(= (unharvest-field) 13.0)
		(= (mill-cost) -15.0)
		(= (inventory-cost) 0.0)
		(= (handling-cost) -14.0)
		(= (cost-process mill1) -10.0)
		(= (cost-process mill2) -5.0)
		(= (has-resource sugar-cane mill1) 8.0)
		(= (has-resource sugar-cane mill2) -9.0)
		(= (max-changing mill1) 16.0)
		(= (max-changing mill2) 14.0)
		(= (max-produce mill1) 6.0)
		(= (max-produce mill2) 12.0)
		(available mill1)
		(available mill2)
		...
		(= (in-storage mill1 brand1) -12.0)
		(= (in-storage mill1 brand3) 6.0)
		(= (in-storage mill1 brand4) 5.0)
		(= (in-storage mill2 brand1) -7.0)
		(= (in-storage mill2 brand2) -2.0)
		(= (in-storage mill2 brand3) -13.0)
		...
		(= (service-time crane1) 22.0)
		(= (service-time crane2) 17.0)
		(= (service-time crane3) 21.0)
		(= (max-service-time crane1) 3.0)
		(= (max-service-time crane2) 10.0)
		(= (max-service-time crane3) 10.0)
		(= (in-truck-sugar brand1 truck1) -3.0)
		(= (in-truck-sugar brand2 truck1) 1.0)
		(= (in-truck-sugar brand3 truck1) -9.0)
		(= (in-truck-sugar brand4 truck1) 5.0)
		(= (in-truck-sugar brand1 truck2) -8.0)
		(= (in-truck-sugar brand2 truck2) 2.0)
		(= (in-truck-sugar brand3 truck2) -1.0)
		(= (in-truck-sugar brand4 truck2) -1.0)
		(= (in-storage depot1 brand1) -15.0)
		(= (in-storage depot1 brand2) -10.0)
		(= (in-storage depot1 brand3) -12.0)
		(= (in-storage depot1 brand4) 11.0)
		(= (in-storage depot2 brand1) -1.0)
		(= (in-storage depot2 brand2) -14.0)
		(= (in-storage depot2 brand3) 9.0)
		(= (in-storage depot2 brand4) 3.0)
		(= (in-storage depot3 brand1) -7.0)
		(= (in-storage depot3 brand2) 10.0)
		(= (in-storage depot3 brand3) 10.0)
