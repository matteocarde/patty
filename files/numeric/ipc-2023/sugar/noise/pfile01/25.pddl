(define (problem prob1)
	...
	(:init
		(= (unharvest-field) 12.0)
		(= (mill-cost) -14.0)
		(= (inventory-cost) -24.0)
		(= (handling-cost) 24.0)
		(= (cost-process mill1) -19.0)
		(= (cost-process mill2) -5.0)
		(= (has-resource sugar-cane mill1) 27.0)
		(= (has-resource sugar-cane mill2) 20.0)
		(= (max-changing mill1) 4.0)
		(= (max-changing mill2) 15.0)
		(= (max-produce mill1) -17.0)
		...
		(= (in-storage mill1 brand1) 15.0)
		(= (in-storage mill1 brand3) -2.0)
		(= (in-storage mill1 brand4) -23.0)
		(= (in-storage mill2 brand1) 22.0)
		(= (in-storage mill2 brand2) 12.0)
		(= (in-storage mill2 brand3) -17.0)
		...
		(ready-crane crane1)
		(ready-crane crane2)
		(= (capacity crane1) 14.0)
		(= (capacity crane2) 4.0)
		(= (service-time crane1) -14.0)
		(= (service-time crane2) 17.0)
		(= (service-time crane3) 31.0)
		(= (max-service-time crane1) 10.0)
		(= (max-service-time crane2) 0.0)
		(= (max-service-time crane3) 7.0)
		(= (in-truck-sugar brand1 truck1) 15.0)
		(= (in-truck-sugar brand2 truck1) -4.0)
		(= (in-truck-sugar brand3 truck1) 4.0)
		(= (in-truck-sugar brand4 truck1) 0.0)
		(= (in-truck-sugar brand1 truck2) 19.0)
		(= (in-truck-sugar brand2 truck2) 17.0)
		(= (in-truck-sugar brand3 truck2) 1.0)
		(= (in-truck-sugar brand4 truck2) 13.0)
		(= (in-storage depot1 brand1) -2.0)
		(= (in-storage depot1 brand2) -23.0)
		(= (in-storage depot1 brand3) -14.0)
		(= (in-storage depot1 brand4) 4.0)
		(= (in-storage depot2 brand1) -18.0)
		(= (in-storage depot2 brand2) -13.0)
		(= (in-storage depot2 brand3) 24.0)
		(= (in-storage depot2 brand4) -2.0)
		(= (in-storage depot3 brand1) -20.0)
		(= (in-storage depot3 brand2) -18.0)
		(= (in-storage depot3 brand3) -13.0)
		(= (in-storage depot3 brand4) -15.0)
