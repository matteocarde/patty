(define (problem mprime-x-18)
   ...
   (:objects
      guava chocolate wonderbread pepper cantelope tofu pea rice scallop hotdog lemon cucumber chicken haroset bacon potato orange marzipan broccoli wurst endive turkey - food
      entertainment learning curiosity rest triumph expectation satisfaction - pleasure
      jealousy prostatitis depression hangover angina anger grief boils sciatica - pain
   )
   (:init
      (= (harmony rest) 1)
