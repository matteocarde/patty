(define (problem mprime-x-22)
   ...
   (:objects
      lettuce marzipan wonderbread onion bacon popover ham guava chicken cantelope pepper scallop beef wurst lamb pea cherry shrimp hamburger kale muffin - food
      stimulation curiosity triumph understanding expectation entertainment intoxication satisfaction aesthetics achievement love lubricity rest learning excitement satiety - pleasure
      angina grief prostatitis jealousy dread boils hangover anger depression loneliness abrasion sciatica laceration anxiety dread-2 sciatica-1 hangover-4 abrasion-3 - pain
   )
   (:init
