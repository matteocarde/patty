...
(define (domain civ)
  ...
  (:functions
    (available-timber ?s - store)
    (available-wood ?s - store)
    (available-coal ?s - store)
    (available-stone ?s - store)
    (available-iron ?s - store)
    (available-ore ?s - store)
    (space-in ?v - vehicle)
    (carts-at ?l - place)
    (labour)
    (resource-use)
  ...
  (:action load-timber
    ...
    :precondition (and (is-at ?v ?p)
      (> (available-timber ?p) 0)
      (> (space-in ?v) 0))
    :effect (and (decrease (space-in ?v) 1)
      (increase (available-timber ?v) 1)
  ...
  (:action load-coal
    ...
    :precondition (and (is-at ?v ?p)
      ...
      (> (space-in ?v) 0))
    :effect (and (decrease (space-in ?v) 1)
      (increase (available-coal ?v) 1)
      (decrease (available-coal ?p) 1)
      (increase (labour) 1))
  )
  (:action load-stone
    :parameters (?v - vehicle ?p - place)
  ...
  (:action load-iron
    ...
    :precondition (and (is-at ?v ?p)
      ...
      (> (space-in ?v) 0))
    :effect (and (decrease (space-in ?v) 1)
      (increase (available-iron ?v) 1)
      (decrease (available-iron ?p) 1)
      (increase (labour) 1))
  )
  (:action load-ore
    :parameters (?v - vehicle ?p - place)
    :precondition (and (is-at ?v ?p)
      ...
      (> (space-in ?v) 0))
    :effect (and (decrease (space-in ?v) 1)
      (increase (available-ore ?v) 1)
      (decrease (available-ore ?p) 1)
      (increase (labour) 1))
  )
  ...
  (:action unload-timber
    :parameters (?v - vehicle ?p - place)
    :precondition (and (is-at ?v ?p)
      (> (available-timber ?v) 0))
    :effect (and (increase (space-in ?v) 1)
      (decrease (available-timber ?v) 1)
      (increase (available-timber ?p) 1)
      (increase (labour) 1))
  )
  (:action unload-wood
    :parameters (?v - vehicle ?p - place)
  ...
  (:action unload-stone
    ...
    :precondition (and (is-at ?v ?p)
      (> (available-stone ?v) 0))
    :effect (and (increase (space-in ?v) 1)
      (decrease (available-stone ?v) 1)
      (increase (available-stone ?p) 1)
      (increase (labour) 1))
  )
  (:action unload-iron
    :parameters (?v - vehicle ?p - place)
  ...
  (:action unload-ore
    ...
    :precondition (and (is-at ?v ?p)
      (> (available-ore ?v) 0))
    :effect (and (increase (space-in ?v) 1)
      (decrease (available-ore ?v) 1)
      (increase (available-ore ?p) 1)
      (increase (labour) 1))
  )
  ...
  ;; (:constants timber wood coal stone iron ore - resource)
  (:action move-laden-cart-timber
    :parameters (?p1 - place ?p2 - place)
    :precondition (and (connected-by-land ?p1 ?p2)
      (>= (carts-at ?p1) 1)
      (>= (available-timber ?p1) 1))
    :effect (and (decrease (carts-at ?p1) 1)
      (increase (carts-at ?p2) 1)
      (decrease (available-timber ?p1) 1)
      (increase (available-timber ?p2) 1)
      (increase (labour) 2))
  )

  (:action move-laden-cart-wood
    :parameters (?p1 - place ?p2 - place)
    :precondition (and (connected-by-land ?p1 ?p2)
      (>= (carts-at ?p1) 1)
      (>= (available-wood ?p1) 1))
    :effect (and (decrease (carts-at ?p1) 1)
      (increase (carts-at ?p2) 1)
      (decrease (available-wood ?p1) 1)
      (increase (available-wood ?p2) 1)
      (increase (labour) 2))
  )
  (:action move-laden-cart-coal
    :parameters (?p1 - place ?p2 - place)
    :precondition (and (connected-by-land ?p1 ?p2)
      (>= (carts-at ?p1) 1)
      (>= (available-coal ?p1) 1))
    :effect (and (decrease (carts-at ?p1) 1)
      (increase (carts-at ?p2) 1)
      (decrease (available-coal ?p1) 1)
      (increase (available-coal ?p2) 1)
      (increase (labour) 2))
  )
  (:action move-laden-cart-stone
    :parameters (?p1 - place ?p2 - place)
    :precondition (and (connected-by-land ?p1 ?p2)
      (>= (carts-at ?p1) 1)
      (>= (available-stone ?p1) 1))
    :effect (and (decrease (carts-at ?p1) 1)
      (increase (carts-at ?p2) 1)
      (decrease (available-stone ?p1) 1)
      (increase (available-stone ?p2) 1)
      (increase (labour) 2))
  )
  (:action move-laden-cart-iron
    :parameters (?p1 - place ?p2 - place)
    :precondition (and (connected-by-land ?p1 ?p2)
      (>= (carts-at ?p1) 1)
      (>= (available-iron ?p1) 1))
    :effect (and (decrease (carts-at ?p1) 1)
      ...
      (increase (available-iron ?p2) 1)
      (increase (labour) 2))
  )
  (:action move-laden-cart-ore
    :parameters (?p1 - place ?p2 - place)
    :precondition (and (connected-by-land ?p1 ?p2)
      (>= (carts-at ?p1) 1)
      (>= (available-ore ?p1) 1))
    :effect (and (decrease (carts-at ?p1) 1)
      (increase (carts-at ?p2) 1)
      (decrease (available-ore ?p1) 1)
      (increase (available-ore ?p2) 1)
      (increase (labour) 2))
  )
