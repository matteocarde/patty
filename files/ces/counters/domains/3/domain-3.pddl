        ...
        (define (domain counters)
            ...
            (:predicates
                ...
                (l01 ?a - counter ?b - counter)(l02 ?a - counter ?b - counter)(l03 ?a - counter ?b - counter)
                (x01 ?a - counter)(x02 ?a - counter)(x03 ?a - counter)
            )
            ...
            (:action incr
                ...
                :effect(and
                    ...
                    (when
                        (and (x03 ?a)(x02 ?a)(x01 ?a))
                        (and (not (x03 ?a))(not (x02 ?a))(not (x01 ?a)))
                    )
                )
            )
