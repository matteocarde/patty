        ...
        (define (domain counters)
            ...
            (:predicates
                ...
                (l01 ?a - counter ?b - counter)(l02 ?a - counter ?b - counter)(l03 ?a - counter ?b - counter)(l04 ?a - counter ?b - counter)(l05 ?a - counter ?b - counter)(l06 ?a - counter ?b - counter)(l07 ?a - counter ?b - counter)(l08 ?a - counter ?b - counter)(l09 ?a - counter ?b - counter)
                (x01 ?a - counter)(x02 ?a - counter)(x03 ?a - counter)(x04 ?a - counter)(x05 ?a - counter)(x06 ?a - counter)(x07 ?a - counter)(x08 ?a - counter)(x09 ?a - counter)
            )
            ...
            (:action incr
                ...
                :effect(and
                    ...
                    (when
                        (and (x09 ?a)(x08 ?a)(x07 ?a)(x06 ?a)(x05 ?a)(x04 ?a)(x03 ?a)(x02 ?a)(x01 ?a))
                        (and (not (x09 ?a))(not (x08 ?a))(not (x07 ?a))(not (x06 ?a))(not (x05 ?a))(not (x04 ?a))(not (x03 ?a))(not (x02 ?a))(not (x01 ?a)))
                    )
                )
            )
