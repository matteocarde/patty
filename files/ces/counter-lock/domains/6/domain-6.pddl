        ...
        (define (domain counter)
            ...
            (:action inx
                ...
                :effect(and
                    ...
                    (when
                        (and (x6)(x5)(x4)(x3)(x2)(x1)(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
            ...
            (:action iny
                ...
                :effect(and
                    ...
                    (when
                        (and (y6)(y5)(y4)(y3)(y2)(y1)(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
            ...
            (:action dex
                ...
                :effect(and
                    ...
                    (when
                        (and (not (x6))(not (x5))(not (x4))(not (x3))(not (x2))(not (x1))(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
            ...
            (:action dey
                ...
                :effect(and
                    ...
                    (when
                        (and (not (y6))(not (y5))(not (y4))(not (y3))(not (y2))(not (y1))(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
