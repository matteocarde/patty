...
(define (problem pb152)
    ...
    (:init
        ...
        (x05 a01) (x04 a01) (x03 a01) (x02 a01) (x02 a02) (x05 a03) (x04 a03) (x02 a03) (x01 a03) (x05 a04) (x03 a04) (x02 a04) (x05 a05) (x03 a05) (x02 a05) (x01 a05) (x05 a06) (x01 a06) (x05 a07) (x04 a07) (x03 a07) (x02 a07)
    )
    (:goal
        (and  
