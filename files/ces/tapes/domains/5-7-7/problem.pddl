...
(define (problem pb152)
    ...
    (:init
        ...
        (x05 a01) (x04 a01) (x05 a02) (x04 a02) (x03 a02) (x01 a02) (x05 a03) (x02 a03) (x05 a04) (x04 a04) (x02 a04) (x01 a04) (x04 a05) (x02 a05) (x05 a06) (x02 a06) (x03 a07) (x02 a07) (x01 a07)
    )
    (:goal
        (and  
