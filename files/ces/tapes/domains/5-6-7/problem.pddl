...
(define (problem pb145)
    ...
    (:init
        ...
        (x04 a01) (x03 a01) (x01 a01) (x03 a02) (x02 a02) (x05 a03) (x04 a03) (x01 a03) (x05 a04) (x04 a04) (x03 a04) (x02 a04) (x01 a04) (x04 a05) (x03 a05) (x02 a05) (x04 a06) (x02 a06) (x01 a06)
    )
    (:goal
        (and  
