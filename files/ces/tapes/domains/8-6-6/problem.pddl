...
(define (problem pb312)
    ...
    (:init
        ...
        (x08 a01) (x07 a01) (x04 a01) (x03 a01) (x02 a01) (x01 a01) (x08 a02) (x07 a02) (x05 a02) (x07 a03) (x06 a03) (x03 a03) (x02 a03) (x01 a03) (x07 a04) (x06 a04) (x05 a04) (x04 a04) (x07 a05) (x05 a05) (x04 a05) (x02 a05) (x01 a05) (x04 a06) (x03 a06)
    )
    (:goal
        (and  
