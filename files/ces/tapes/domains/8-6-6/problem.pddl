...
(define (problem pb312)
    ...
    (:init
        ...
        (x07 a01) (x08 a02) (x04 a02) (x03 a02) (x08 a03) (x05 a03) (x03 a03) (x02 a03) (x08 a04) (x07 a04) (x06 a04) (x04 a04) (x03 a04) (x01 a04) (x03 a05) (x07 a06) (x06 a06) (x05 a06) (x04 a06) (x03 a06)
    )
    (:goal
        (and  
