...
(define (problem pb313)
    ...
    (:init
        ...
        (x08 a01) (x07 a01) (x05 a01) (x04 a01) (x08 a02) (x05 a02) (x06 a03) (x03 a03) (x01 a03) (x08 a04) (x05 a04) (x04 a04) (x03 a04) (x02 a04) (x01 a04) (x06 a05) (x05 a05) (x01 a05) (x08 a06) (x04 a06) (x03 a06) (x02 a06)
    )
    (:goal
        (and  
