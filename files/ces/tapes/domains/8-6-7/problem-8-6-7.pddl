...
(define (problem pb313)
    ...
    (:init
        ...
        (x08 a01) (x07 a01) (x06 a01) (x05 a01) (x04 a01) (x02 a01) (x01 a01) (x04 a02) (x03 a02) (x08 a03) (x06 a03) (x04 a03) (x03 a03) (x02 a03) (x01 a03) (x08 a04) (x06 a04) (x04 a04) (x03 a04) (x02 a04) (x01 a04) (x08 a05) (x07 a05) (x06 a05) (x05 a05) (x04 a05) (x03 a05) (x02 a05) (x08 a06) (x06 a06) (x04 a06) (x03 a06)
    )
    (:goal
        (and  
