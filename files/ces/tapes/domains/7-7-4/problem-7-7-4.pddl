...
(define (problem pb261)
    ...
    (:init
        ...
        (x01 a01) (x04 a02) (x02 a02) (x01 a02) (x06 a03) (x03 a03) (x02 a03) (x07 a04) (x03 a04) (x02 a04) (x01 a04) (x05 a05) (x07 a06) (x06 a06) (x05 a06) (x07 a07) (x06 a07) (x05 a07) (x03 a07) (x02 a07)
    )
    (:goal
        (and  
