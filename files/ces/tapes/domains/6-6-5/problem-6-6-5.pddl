...
(define (problem pb199)
    ...
    (:init
        ...
        (x04 a01) (x03 a01) (x01 a01) (x06 a02) (x05 a02) (x01 a02) (x03 a03) (x06 a04) (x05 a04) (x04 a04) (x03 a04) (x04 a05) (x03 a05) (x01 a05) (x06 a06) (x05 a06) (x03 a06)
    )
    (:goal
        (and  
