...
(define (problem pb197)
    ...
    (:init
        ...
        (x06 a01) (x05 a01) (x04 a01) (x03 a01) (x06 a02) (x04 a02) (x02 a02) (x01 a02) (x06 a03) (x05 a03) (x03 a03) (x01 a03) (x06 a04) (x04 a04) (x03 a04) (x02 a04) (x01 a04) (x06 a05) (x02 a05) (x06 a06) (x04 a06)
    )
    (:goal
        (and  
