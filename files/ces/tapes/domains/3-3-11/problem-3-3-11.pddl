    ...
    (define (problem pb15)
        ...
        (:objects 
            ...
            t01 t02 t03 - tape
            a01 a02 a03 - counter
            c01 c02 c03 c04 c05 c06 c07 c08 c09 c10 c11 - cell
        )
        (:init
            (onTape r t01)
            (onCellRobot r c01)
            (onCellCounter a01 t01 c06) (onCellCounter a02 t02 c06) (onCellCounter a03 t03 c06)
            (startCell c01)
            (isNextCell c01 c02) (isNextCell c02 c03) (isNextCell c03 c04) (isNextCell c04 c05) (isNextCell c05 c06) (isNextCell c06 c07) (isNextCell c07 c08) (isNextCell c08 c09) (isNextCell c09 c10) (isNextCell c10 c11) (isNextCell c11 c01)
