...
(define (problem pb256)
    ...
    (:init
        ...
        (x06 a01) (x03 a01) (x07 a02) (x06 a02) (x04 a02) (x03 a02) (x06 a03) (x04 a03) (x01 a03) (x07 a04) (x06 a04) (x05 a04) (x04 a04) (x03 a04) (x01 a04) (x06 a05) (x05 a05) (x04 a05) (x02 a05) (x05 a06) (x04 a06) (x03 a06) (x02 a06)
    )
    (:goal
        (and  
