...
(define (problem pb264)
    ...
    (:init
        ...
        (x01 a01) (x07 a02) (x02 a02) (x01 a02) (x06 a03) (x05 a03) (x04 a03) (x04 a04) (x03 a04) (x01 a04) (x05 a05) (x03 a05) (x02 a05) (x07 a06) (x06 a06) (x03 a06) (x07 a07) (x05 a07) (x02 a07) (x01 a07)
    )
    (:goal
        (and  
