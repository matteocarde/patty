...
(define (problem pb151)
    ...
    (:init
        ...
        (x04 a01) (x02 a01) (x01 a01) (x05 a02) (x04 a02) (x03 a02) (x02 a02) (x01 a02) (x04 a03) (x03 a03) (x02 a03) (x03 a04) (x02 a04) (x01 a04) (x05 a05) (x02 a05) (x01 a05) (x05 a06) (x04 a06) (x02 a06) (x01 a06) (x05 a07) (x04 a07) (x03 a07) (x01 a07)
    )
    (:goal
        (and  
