...
(define (problem pb200)
    ...
    (:init
        ...
        (x06 a01) (x05 a01) (x04 a01) (x03 a01) (x02 a01) (x06 a02) (x05 a02) (x03 a02) (x01 a02) (x06 a03) (x05 a03) (x04 a03) (x03 a03) (x02 a03) (x05 a04) (x04 a04) (x03 a04) (x06 a05) (x02 a06) (x01 a06)
    )
    (:goal
        (and  
