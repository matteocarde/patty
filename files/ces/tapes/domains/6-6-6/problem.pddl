...
(define (problem pb200)
    ...
    (:init
        ...
        (x06 a01) (x03 a01) (x02 a01) (x01 a01) (x06 a02) (x03 a02) (x01 a02) (x06 a03) (x05 a03) (x03 a03) (x01 a03) (x05 a04) (x01 a04) (x06 a05) (x04 a05) (x01 a05) (x05 a06) (x03 a06) (x02 a06) (x01 a06)
    )
    (:goal
        (and  
