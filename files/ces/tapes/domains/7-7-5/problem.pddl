...
(define (problem pb262)
    ...
    (:init
        ...
        (x03 a01) (x05 a02) (x04 a02) (x03 a02) (x07 a03) (x06 a03) (x03 a03) (x02 a03) (x01 a03) (x07 a04) (x06 a04) (x05 a05) (x02 a05) (x07 a06) (x02 a06) (x07 a07) (x05 a07) (x03 a07) (x02 a07)
    )
    (:goal
        (and  
