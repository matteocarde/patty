...
(define (problem pb262)
    ...
    (:init
        ...
        (x07 a01) (x05 a01) (x04 a01) (x01 a01) (x06 a02) (x03 a02) (x07 a03) (x06 a03) (x05 a03) (x01 a03) (x06 a04) (x05 a04) (x03 a04) (x06 a05) (x05 a05) (x04 a05) (x03 a05) (x01 a05) (x07 a06) (x05 a06) (x03 a06) (x03 a07) (x02 a07)
    )
    (:goal
        (and  
