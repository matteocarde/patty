...
(define (problem pb149)
    ...
    (:init
        ...
        (x05 a01) (x04 a01) (x03 a01) (x04 a02) (x03 a02) (x02 a02) (x05 a03) (x02 a03) (x01 a03) (x01 a04) (x05 a05) (x04 a05) (x02 a05) (x01 a05) (x03 a06) (x01 a06) (x05 a07) (x03 a07) (x02 a07)
    )
    (:goal
        (and  
