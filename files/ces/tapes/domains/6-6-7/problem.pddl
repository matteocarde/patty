...
(define (problem pb201)
    ...
    (:init
        ...
        (x06 a01) (x05 a01) (x04 a01) (x01 a01) (x06 a02) (x03 a02) (x06 a03) (x04 a03) (x03 a03) (x02 a03) (x01 a03) (x06 a04) (x05 a04) (x04 a04) (x05 a05) (x04 a05) (x05 a06) (x03 a06) (x02 a06) (x01 a06)
    )
    (:goal
        (and  
