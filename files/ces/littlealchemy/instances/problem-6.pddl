(define (problem pb01)
            (:domain counters)
            (:objects sea earth stone atmosphere wall dust rain earthquake fire lava gunpowder air fog water geyser wind ocean salt metal mud obsidian plant mountain sand flood cloud brick sky storm granite steam pressure energy volcano - element)
            (:init
                (have water)
                (have earth)
                (have fire)
