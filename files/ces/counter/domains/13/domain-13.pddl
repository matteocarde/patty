        ...
        (define (domain counter)
            ...
            (:action incr
                ...
                :effect(and
                    ...
                    (when
                        (and (x13)(x12)(x11)(x10)(x09)(x08)(x07)(x06)(x05)(x04)(x03)(x02)(x01))
                        (and (not (x13))(not (x12))(not (x11))(not (x10))(not (x09))(not (x08))(not (x07))(not (x06))(not (x05))(not (x04))(not (x03))(not (x02))(not (x01)))
                    )
                )
            )
        )
