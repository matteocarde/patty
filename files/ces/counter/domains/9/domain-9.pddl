        ...
        (define (domain counter)
            ...
            (:action inx
                ...
                :effect(and
                    ...
                    (when
                        (and (x9)(x8)(x7)(x6)(x5)(x4)(x3)(x2)(x1)(not (l9))(not (l8))(not (l7))(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
                        (and (not (x9))(not (x8))(not (x7))(not (x6))(not (x5))(not (x4))(not (x3))(not (x2))(not (x1)))
                    )
                )
            )
            (:action iny
                ...
                :effect(and
                    ...
                    (when
                        (and (y9)(y8)(y7)(y6)(y5)(y4)(y3)(y2)(y1)(not (l9))(not (l8))(not (l7))(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
                        (and (not (y9))(not (y8))(not (y7))(not (y6))(not (y5))(not (y4))(not (y3))(not (y2))(not (y1)))
                    )
                )
            )
            ...
            (:action dex
                ...
                :effect(and
                    ...
                    (when
                        (and (not (x9))(not (x8))(not (x7))(not (x6))(not (x5))(not (x4))(not (x3))(not (x2))(not (x1))(not (l9))(not (l8))(not (l7))(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
                        (and (x9)(x8)(x7)(x6)(x5)(x4)(x3)(x2)(x1))
                    )
                )
            )
            (:action dey
                ...
                :effect(and
                    ...
                    (when
                        (and (not (y9))(not (y8))(not (y7))(not (y6))(not (y5))(not (y4))(not (y3))(not (y2))(not (y1))(not (l9))(not (l8))(not (l7))(not (l6))(not (l5))(not (l4))(not (l3))(not (l2))(not (l1)))
                        (and (y9)(y8)(y7)(y6)(y5)(y4)(y3)(y2)(y1))
                    )
                )
            )
            (:action lck
