        ...
        (define (domain counter)
            ...
            (:action inx
                ...
                :effect(and
                    ...
                    (when
                        (and (x4)(x3)(x2)(x1)(not (l4))(not (l3))(not (l2))(not (l1)))
            ...
            (:action iny
                ...
                :effect(and
                    ...
                    (when
                        (and (y4)(y3)(y2)(y1)(not (l4))(not (l3))(not (l2))(not (l1)))
            ...
            (:action dex
                ...
                :effect(and
                    ...
                    (when
                        (and (not (x4))(not (x3))(not (x2))(not (x1))(not (l4))(not (l3))(not (l2))(not (l1)))
                        (and (x4)(x3)(x2)(x1))
                    )
                )
            )
            (:action dey
                ...
                :effect(and
                    ...
                    (when
                        (and (not (y4))(not (y3))(not (y2))(not (y1))(not (l4))(not (l3))(not (l2))(not (l1)))
                        (and (y4)(y3)(y2)(y1))
                    )
                )
            )
