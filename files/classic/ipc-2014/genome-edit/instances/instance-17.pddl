...
(define (problem platycodon-to-triodanus)
    ...
    (:objects
        sub17 sub16 sub15 sub14 sub13 sub12 sub11 sub10 sub9 sub8 sub7 sub6 sub5 sub4 sub3 sub2 sub1 g97 g56 g49 g28 g9 g8 g1 - object
    )
    (:init
        (normal g1)
        (normal g8)
    ...
    (:goal
        (and (normal g1) (normal sub10) (normal sub15)
