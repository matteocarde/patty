...
(define (problem merciera-to-legousia)
    (:domain genome-edit-distance)
    (:objects
        sub13 sub12 sub11 sub10 sub9 sub8 sub7 sub6 sub5 sub4 sub3 sub2 sub1 g97 g84 g55 g54 g53 g35 - object
    )
    (:init
        (normal sub12)
        (normal sub11)
    ...
    (:goal
        (and (normal sub12) (normal sub13) (normal sub1)
