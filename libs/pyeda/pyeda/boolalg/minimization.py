...
from libs.pyeda.pyeda.boolalg.expr import And, Expression, Or, exprvar
from libs.pyeda.pyeda.boolalg.table import PC_DC, PC_ONE, PC_ZERO, TruthTable
...
if os.getenv("READTHEDOCS") == "True":
    ...
    from libs.pyeda.pyeda.boolalg.espresso import (DTYPE, FTYPE, RTYPE, espresso,
                                        set_config)
...
def espresso_exprs(*exprs):
    ...
    For example::
       ...
       >>> from libs.pyeda.pyeda.boolalg.expr import exprvar
...
def espresso_tts(*tts):
    ...
    For example::
       ...
       >>> from libs.pyeda.pyeda.boolalg.table import truthtable
       >>> X = exprvars("x", 4)
